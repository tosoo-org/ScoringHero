...
def scoring_import_window(ui, filetype):
    ...
    # For tosoo scoring imports, do not overwrite ui.filename — keep the EEG-derived
    # name so subsequent writes go to a new file rather than overwriting the source.
    if filetype != "tosoo":
